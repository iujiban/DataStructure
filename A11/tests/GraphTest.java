...
public class GraphTest {
    ...
    //    System.out.println(2);
      ...
      //  System.out.println(3);
        TreePrinter.print(h.findMin()); // if I have this one I got error
    ...
    public void ownTest() {
        ...
        ArrayList<Item> nodes = new ArrayList<>(Arrays.asList(p1,p2,p3,p4,p5,p6,p7,p8));
        Hashtable<Item, ArrayList<Item>> neighbors = new Hashtable<>();

        neighbors.put(p1, new ArrayList<>());
        neighbors.put(p2, new ArrayList<>(Arrays.asList(p1)));
        neighbors.put(p3, new ArrayList<>(Arrays.asList(p2)));
        neighbors.put(p4, new ArrayList<>(Arrays.asList(p1,p2,p5)));
        neighbors.put(p5, new ArrayList<>(Arrays.asList(p6,p7)));
        neighbors.put(p6, new ArrayList<>(Arrays.asList(p7)));
        neighbors.put(p7, new ArrayList<>(Arrays.asList(p8)));
        neighbors.put(p8, new ArrayList<>(Arrays.asList()));
        ...
        Graph g = new Graph(nodes, neighbors, weights);
        g.allShortestPaths(p4);

        //Every nodes should be visited
        assertTrue(p1.isVisited());
        assertTrue(p2.isVisited());
        assertTrue(p3.isVisited());
        assertTrue(p4.isVisited());
        assertTrue(p5.isVisited());
        assertTrue(p6.isVisited());
        assertTrue(p7.isVisited());
        assertTrue(p8.isVisited());

        assertEquals(null, p4.getPrevious());
        assertEquals(p2, p1.getPrevious());
        assertEquals(p4, p2.getPrevious());
        assertEquals(p4, p5.getPrevious());
        assertEquals(p5, p6.getPrevious());
        assertEquals(p5, p7.getPrevious());
        assertEquals(p7, p8.getPrevious());

        g.shortestPath(p4, p1);

        assertFalse(p1.isVisited());
        assertTrue(p2.isVisited());
        assertFalse(p3.isVisited());
        assertTrue(p5.isVisited());
        assertTrue(p6.isVisited());
        assertTrue(p7.isVisited());
        assertFalse(p8.isVisited());

        assertEquals(p2, p1.getPrevious());
        assertEquals(p4, p2.getPrevious());
        assertEquals(null, p3.getPrevious());
        assertEquals(null, p4.getPrevious());
        assertEquals(p4, p5.getPrevious());
        assertEquals(p5, p6.getPrevious());
        assertEquals(p5, p7.getPrevious());
        ...
        g.shortestPath(p4, p8); //since pp8 is very far away, we need to visit every place...
        assertTrue(p1.isVisited());
        assertTrue(p2.isVisited());
        assertTrue(p5.isVisited());
        assertTrue(p6.isVisited());
